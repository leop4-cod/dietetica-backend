...
INTEGRANTES: LEOPOLDO PEREZ, ALIYHA MAZSORRA, MARIA JOSE TACO 

Dietetica Backend 
Esta desarrollada con NestJS para la gestion de un sistema de ventas de productos dieteticos. Este proyecto utiliza una Arquitectura hibrida de Bases de Datos, combinando la robustez relacional de PostgreSQL con la flexibilidad de MongoDB
